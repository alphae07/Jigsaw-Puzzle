...
const Level12 = () => {
  ...
  const shuffleArray = (array) => {
    ...
    <div>
        <div className="float">
            <h4>Image</h4>
        <img src={img12} alt="Puzzle" className="pic" />
        </div>
        <div className="puzz puzz12" 
                onMouseEnter={turn}>
            <JigsawPuzzle
                imageSrc = {img12}
                rows={4}
                columns={4}
                onSolved={set}
                className="jigsaw-puzzle puzz12"
            />        
            </div>
            <div className="mann">
          ...
          <Link to='/level11'><button onClick={() => handleLevelChange(level - 1)}>Previous Level</button></Link>
          ...
          <Link to='/level13'><button onClick={() => handleLevelChange(level + 1)}>Next Level</button></Link>
