...
const Level7 = () => {
  ...
  const shuffleArray = (array) => {
    ...
    <div>
        <div className="float">
            <h4>Image</h4>
        <img src={img7} alt="Puzzle" className="pic" />
        </div>
        <div className="puzz puzz7" 
                onMouseEnter={turn}>
            <JigsawPuzzle
                imageSrc = {img7}
                rows={3}
          ...
          <Link to='/level6'><button onClick={() => handleLevelChange(level - 1)}>Previous Level</button></Link>
          ...
          <Link to='/level8'><button onClick={() => handleLevelChange(level + 1)}>Next Level</button></Link>
