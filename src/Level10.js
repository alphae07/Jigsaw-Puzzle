...
const Level10 = () => {
  ...
  const shuffleArray = (array) => {
    ...
    <div>
        <div className="float">
            <h4>Image</h4>
        <img src={img10} alt="Puzzle" className="pic" />
        </div>
        <div className="puzz puzz10" 
                onMouseEnter={turn}>
            <JigsawPuzzle
                imageSrc = {img10}
                rows={4}
                columns={4}
                onSolved={set}
                className="jigsaw-puzzle puzz10"
            />        
            </div>
            <div className="mann">
          ...
          <Link to='/level9'><button onClick={() => handleLevelChange(level - 1)}>Previous Level</button></Link>
          ...
          <Link to='/level11'><button onClick={() => handleLevelChange(level + 1)}>Next Level</button></Link>
