...
const Level3 = () => {
  ...
  const shuffleArray = (array) => {
    ...
    <div>
        <div className="float">
            <h4>Image</h4>
        <img src={img3} alt="Puzzle" className="pic" />
        </div>
        <div className="puzz puzz3" 
                onMouseEnter={turn}>
            <JigsawPuzzle
                imageSrc = {img3}
                rows={3}
          ...
          <Link to='/level2'><button onClick={() => handleLevelChange(level - 1)}>Previous Level</button></Link>
          ...
          <Link to='/level4'><button onClick={() => handleLevelChange(level + 1)}>Next Level</button></Link>
