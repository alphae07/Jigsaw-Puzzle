...
const Level11 = () => {
  ...
  const shuffleArray = (array) => {
    ...
    <div>
        <div className="float">
            <h4>Image</h4>
        <img src={img11} alt="Puzzle" className="pic" />
        </div>
        <div className="puzz puzz11" 
                onMouseEnter={turn}>
            <JigsawPuzzle
                imageSrc = {img11}
                rows={4}
                columns={4}
                onSolved={set}
                className="jigsaw-puzzle puzz11"
            />        
            </div>
            <div className="mann">
          ...
          <Link to='/level10'><button onClick={() => handleLevelChange(level - 1)}>Previous Level</button></Link>
          ...
          <Link to='/level12'><button onClick={() => handleLevelChange(level + 1)}>Next Level</button></Link>
