...
const Level8 = () => {
  ...
  const shuffleArray = (array) => {
    ...
    <div>
        <div className="float">
            <h4>Image</h4>
        <img src={img8} alt="Puzzle" className="pic" />
        </div>
        <div className="puzz puzz8" 
                onMouseEnter={turn}>
            <JigsawPuzzle
                imageSrc = {img8}
                rows={3}
          ...
          <Link to='/level7'><button onClick={() => handleLevelChange(level - 1)}>Previous Level</button></Link>
          ...
          <Link to='/level9'><button onClick={() => handleLevelChange(level + 1)}>Next Level</button></Link>
