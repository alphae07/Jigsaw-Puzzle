...
const Level2 = () => {
  ...
  const shuffleArray = (array) => {
    ...
    <div>
        <div className="float">
            <h4>Image</h4>
        <img src={img2} alt="Puzzle" className="pic" />
        </div>
        <div className="puzz2" 
                onMouseEnter={turn}>
            <JigsawPuzzle
          ...
          <Link to='/level1'><button onClick={() => handleLevelChange(level - 1)}>Previous Level</button></Link>
          ...
          <Link to='/level3'><button onClick={() => handleLevelChange(level + 1)}>Next Level</button></Link>
